...
class CityInstantiationTest(unittest.TestCase):
    ...
    def test_created_at_differs(self):
        cy1 = City()
        sleep(0.05)
        cy2 = City()
        self.assertLess(cy1.created_at, cy2.created_at)

    def test_updated_at_differs(self):
        cy1 = City()
        sleep(0.05)
        cy2 = City()
    ...
    def test_str_representation(self):
        ...
        self.assertIn("'created_at': " + repr(dt), cystr)
        self.assertIn("'updated_at': " + repr(dt), cystr)
    ...
    def test_instantiation_with_kwargs(self):
        dt = datetime.today()
        cy = City(id="345", created_at=dt.isoformat(),
